...
function ShowNoPhoneWarning () 
  ...
  ESX.ShowNotification("You dont have ~r~Phone!~s~")
end
--====================================================================================
--                                   SIM MENU                                       --
--====================================================================================
...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    ...
    if ShowNumberNotification == true then
      text = '~o~New message for ~y~'.. message.transmitter
  ...
  if data.eventName ~= 'cancel' then
	if data.data ~= nil then 
		...
		if data.eventName == "police" then
			...
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Police","CHAR_CALL911","POLICE")
		elseif data.eventName == "taxi" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Taxi","CHAR_TAXI","TAXI")
		elseif data.eventName == "mechanic" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Mechanic","CHAR_CARSITE3","MECHANIC")
		elseif data.eventName == "ftnews" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Journaliste","CHAR_LIFEINVADER","FTNEWS") 
		elseif data.eventName == "ambulance" then
			TriggerServerEvent('phone:call', "ambulance", data.data, plyPos['x'], plyPos['y'], plyPos['z'])
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Emergencies","CHAR_CALL911","LSMC")
		elseif data.eventName == "foodtruck" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Foodtruck","CHAR_PROPERTY_BAR_COCKOTOOS","FOODTRUCK") 
		elseif data.eventName == "lawyer" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Lawyer","CHAR_MINOTAUR","AVOCAT")
		elseif data.eventName == "airlines" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Pilot Airlines","CHAR_BOATSITE2","AIRLINES")  
		elseif data.eventName == "bus" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Bus driver","CHAR_PEGASUS_DELIVERY","BUS")
		elseif data.eventName == "airdealer" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Airplane dealer","CHAR_BOATSITE2","CONCESSIONAIRE")
		elseif data.eventName == "brinks" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Bottom transporter", "CHAR_BANK_FLEECA", "BRINKS")
		elseif data.eventName == "banker" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Banker","CHAR_BANK_MAZE","BANQUE")
		elseif data.eventName == "dock" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Boat Dealer","CHAR_BOATSITE","CONCESSIONAIRE")
		elseif data.eventName == "realestateagent" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Real estate agent","CHAR_ACTING_UP","IMMOBILIER")
		elseif data.eventName == "state" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Government","CHAR_EPSILON","MAIRIE")
		elseif data.eventName == "cardealer" then
			TriggerEvent('esx_extended:showNotification',"~h~You called thee ~b~Car Dealer","CHAR_CARSITE","CONCESSIONAIRE") 
		elseif data.eventName == "biker" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Arms dealer","CHAR_AMMUNATION","AMMUNATION")	
		elseif data.eventName == "fermier" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Farmer","CHAR_MP_MERRYWEATHER","FERMIER")			   
		elseif data.eventName == "unicorn" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Unicorn","CHAR_MP_STRIPCLUB_PR","UNICORN")			   
		elseif data.eventName == "brewer" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Brewers","CHAR_CHAT_CALL","BRASSEUR")	
		elseif data.eventName == "trucker" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Grocer","CHAR_CHAT_CALL","TRUCKER")			   
		elseif data.eventName == "firefighter" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Firefighter","CHAR_CALL911","FIREFIGHTER")			   
		elseif data.eventName == "staff" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Staff","CHAR_CHAT_CALL","STAFF")	
		elseif data.eventName == "fuel" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~LSPI","CHAR_MICHAEL","LSPI")		   
		end	
	else
		local limit = data.limit or 255
		local text = data.text or ''
		if data.eventName ~= "RESPAWN" then
			...
			elseif data.eventName == "mechanic" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Mechanic","CHAR_CARSITE3","MECHANIC")
			elseif data.eventName == "ftnews" then
			TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Journalist","CHAR_LIFEINVADER","FTNEWS")  
			elseif data.eventName == "ambulance" then
				TriggerServerEvent('phone:call', "ambulance", text, plyPos['x'], plyPos['y'], plyPos['z'])
				TriggerEvent('esx_extended:showNotification',"~h~You called thes ~b~Emergencies","CHAR_CALL911","LSMC")
			elseif data.eventName == "foodtruck" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Foodtruck","CHAR_PROPERTY_BAR_COCKOTOOS","FOODTRUCK") 
			elseif data.eventName == "lawyer" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Lawyer","CHAR_MINOTAUR","AVOCAT")
			...
			elseif data.eventName == "state" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Government","CHAR_EPSILON","MAIRIE")
			elseif data.eventName == "cardealer" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Car Dealer","CHAR_CARSITE","CONCESSIONAIRE") 
			elseif data.eventName == "biker" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Arms dealer","CHAR_AMMUNATION","AMMUNATION")	
			elseif data.eventName == "fermier" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Farmer","CHAR_MP_MERRYWEATHER","FERMIER")			   
			elseif data.eventName == "unicorn" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Unicorn","CHAR_MP_STRIPCLUB_PR","UNICORN")			   
			elseif data.eventName == "brewer" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~Tequilala","CHAR_PROPERTY_BAR_TEQUILALA","TEQUILA")	
			elseif data.eventName == "trucker" then
				TriggerEvent('esx_extended:showNotification',"~h~Vous avez appelé l' ~b~Grocer","CHAR_MP_MERRYWEATHER","TRUCKER")		   
			elseif data.eventName == "firefighter" then
				TriggerEvent('esx_extended:showNotification',"~h~You called thes ~b~Firefighters","CHAR_CALL911","FIREFIGHTER")		   
			elseif data.eventName == "bahamas" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~bahamas","CHAR_MICHAEL","BAHAMAS")	
			elseif data.eventName == "fuel" then
				TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~LSPI","CHAR_MICHAEL","LSPI")			   
				-- elseif data.eventName == "staff" then
				-- TriggerEvent('esx_extended:showNotification',"~h~You called the ~b~staff","CHAR_CHAT_CALL","STAFF")		   
					...
					elseif data2.current.value == 'sim_give' then
						...
						if closestPlayer ~= -1 and closestDistance <= 3.0 then
						    if IsPedSittingInAnyVehicle(closestPlayer) then
								ESX.ShowNotification('~r~You cannot give something to someone in a vehicle')
								return
							end
...
function CheckPhone()
	if myPhoneNumber ~= 'nil' and myPhoneNumber ~= nil and tonumber(myPhoneNumber) ~= 0 and myPhoneNumber ~= '' then
	  ESX.TriggerServerCallback('gcphone:getItemAmount', function(qtty)
			...
			--UpMiniMapNotification("Not de ~r~phone~s~")
			TriggerEvent('esx_extended:showNotification', "Not de ~r~phone~s~", 'CHAR_CHAT_CALL','LS Telecom')
		  end
	  end, 'phone')
	else
	  -- UpMiniMapNotification("No ~ r ~ linked sim card ~ s ~, F1 or buy one")
	  TriggerEvent('esx_extended:showNotification', "No ~r~ linked sim card ~s~, F9 or buy one", 'CHAR_CHAT_CALL','LS Telecom')
	end
end
--]]